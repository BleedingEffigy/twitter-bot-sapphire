          ...
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-wrap -m-12">
              <div className="p-12 md:w-1/2 flex flex-col items-start  bg-white/80 shadow-xl ring-1 ring-gray-900/5">
                <span className="inline-block py-1 px-2 rounded bg-red-300 text-red-800 text-bold text-opacity-75 text-xs font-medium tracking-widest">ACTIVE</span>
                <h2 className="sm:text-3xl text-2xl title-font font-medium w-full text-center text-black text-opacity-90 mt-4 mb-4">buildspace—web3 builders</h2>
